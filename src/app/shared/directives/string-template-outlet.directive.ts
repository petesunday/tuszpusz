...
export class ZardStringTemplateOutletDirective<T = unknown> implements OnDestroy {
  ...
  #lastTemplateRef: null | TemplateRef<void> = null;
  #lastContext?: ZardStringTemplateOutletContext;

  readonly zStringTemplateOutletContext = input<undefined | ZardStringTemplateOutletContext>(
    undefined,
  );
  readonly zStringTemplateOutlet = input.required<T | TemplateRef<void>>();

  #hasContextShapeChanged(context: undefined | ZardStringTemplateOutletContext): boolean {
    if (!context) {
      return false;
    }
  ...
  #shouldViewBeRecreated(
    stringTemplateOutlet: T | TemplateRef<void>,
    stringTemplateOutletContext: undefined | ZardStringTemplateOutletContext,
  ): boolean {
  ...
  #recreateView(
    ...
    context: undefined | ZardStringTemplateOutletContext,
  ): void {
